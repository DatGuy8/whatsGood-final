...
<body>
	<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow">
			...
			<ul class="navbar-nav flex-row d-md-none">
				...
				<li class="nav-item text-nowrap">
					<button type="button" class="nav-link px-3 bg-dark text-white border-0"
				...
				<div class="offcanvas-lg offcanvas-end" tabindex="-1"
					...
					<div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
						<ul class="nav flex-column">
							...
							<li class="nav-item">
								<a href="/admin/users" class="nav-link align-items-center gap-2">
							...
							<li class="nav-item">
								<a href="/admin/items" class="nav-link align-items-center gap-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-cup-hot-fill" viewBox="0 0 16 16">
						...
						<div class="col-md-4">
							<div class="card mb-4 box-shadow">
								<img class="card-img-top" src="${photos[0].filePath }" alt="pic of food" height="300px">
								<div class="card-body">
									<p class="card-text">
										Business Name:
